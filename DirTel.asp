...
<link href="layout/scripts/responsiveslides.js-v1.53/responsiveslides.css" rel="stylesheet" type="text/css" media="all">
	<link rel="stylesheet" type="text/css" href="layout/styles/jquery.dataTables.css">
	 <link rel="stylesheet" type="text/css" href="layout/styles/shCore.css">
	<style type="text/css" class="init">
	</style>
	<script type="text/javascript" language="javascript" src="layout/scripts/jquery.js"></script>
	<script type="text/javascript" language="javascript" src="layout/scripts/jquery.dataTables.js"></script>
	<script type="text/javascript" language="javascript" src="layout/scripts/shCore.js"></script>
	<script type="text/javascript" language="javascript" src="layout/scripts/demo.js"></script>
...
<div class="wrapper row3">
  <div id="container">
	<div class="container">
	<center><h1>Directorio Telefonico</h1></center>
		<section>
			<table id="example" class="display" cellspacing="0" width="100%">
				<thead style= "color:#666666;">
					<tr>
						<th style= "color:#666666;">Nombre</th>
						<th style= "color:#666666;">Area</th>
						<th style= "color:#666666;">Extension</th>
					</tr>
				</thead>
				<tbody>
				<%
					objCommand.CommandText ="SELECT Nombre,Puesto,Telefono FROM rh.dbo.Empleados WHERE Telefono <> '' ORDER BY 1"
					...
					while not objrs.eof 
						...
						Cadena=Cadena&"<td align='center' bgcolor='#fff'></h4>"& objrs("Puesto") &"</h4></td>"
						Cadena=Cadena&"<td align='center' bgcolor='#fff'></h4>"& objrs("Telefono") &"</h4></td></tr>"
